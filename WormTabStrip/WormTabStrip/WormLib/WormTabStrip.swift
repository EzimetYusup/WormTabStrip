    ...
    ******************************************/
    ...
    private func setWidthAndHeightOfWormForDistance(distance:CGFloat){
        if distance < 1 {
            ...
            let height:CGFloat  = self.calculatePrespectiveHeightOfWorm(distance)
    ...
    private  func calculatePrespectiveHeightOfWorm(distance:CGFloat)->CGFloat{
